...
function Layout({ children }) {
    return (
        <main className="xl:grid xl:grid-cols-12 pr-10 relative">
            ...
            <div className='col-start-2 col-span-11 pr-6 row-start-1 row-end-3'>
                <div className='fixed bg-opacity-90 w-full flex items-center  backdrop-blur-md z-[2]'>
                        <SearchNormal1 size={18} />
                        <input type="text" className='pt-4 px-4 pb-6 border-none bg-transparent ' placeholder='Search artist' />
                </div>
                <div className='mt-16'>
                    {children}
                </div>
