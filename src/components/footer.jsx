        ...
        <footer className='fixed py-4 px-12 bottom-0 col-span-12 w-full row-start-3 row-end-4 lg:h-28 lg:p-4 bg-black z-[3]  bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border-t border-gray-100'>
            <div className='flex items-center justify-between'>
                <div className='sm:w-1/5  flex items-center'>
                    ...
                    <div className='px-2'>
                        <div className="sm:font-bold ">{track.title}</div>
                ...
                <div className='sm:flex-grow'>
                    <div className='flex justify-center'>
                        ...
                        <span className='p-2 rounded-full cursor-pointer hidden sm:block' onClick={() => previousSong()}><Previous variant='Bold' size={22} /></span>
                        <span className='rounded-full p-2 bg-primary-yellow shadow-[0_0_2px_0] cursor-pointer grow-animation ' onClick={() => setPlaying(!isPlaying)}>{isPlaying ? <Pause  variant="Bold" size={22} /> : <Play variant="Bold"  size={22} />}</span>
                        <span className='p-2 rounded-full cursor-pointer' onClick={() => nextSong()}><Next variant='Bold' size={22} /></span>
