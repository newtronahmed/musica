...
export default function TopSongs({ song, index }) {
    ...
    return (
        <div className='bg-secondary w-full p-4 flex justify-between items-start flex-shrink-0 basis-3/5 shadow-current rounded-xl cursor-pointer active:scale-110' onClick={() => handleSelect({ type: 'topSongs', index })}>
